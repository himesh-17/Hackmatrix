    ...
    <AnimatePresence mode="wait">
      {isOpen ? (
        ...
        >
          ...
          {/* Chat History List (User Requested Change: Chat History instead of Mission Logs) */}
            ...
            <div className="space-y-1">
              {history.length === 0 ? (
                ...
                history.map((item) => (
                  <button
                    key={item.id}
                    className="w-full flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs text-white/80 hover:text-white hover:bg-white/5 transition-all text-left font-mono truncate border border-transparent hover:border-[#f97316]/30"
                  >
