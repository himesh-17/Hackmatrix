...
void gasAt(vec3 p, float rd, float dt, out float dens, out vec3 tint, out float heat) {
  ...
  // half a cycle apart, and the crossfade lands where its layer is weightless.
 ...
 * Keeping the blob near a pixel wide holds the smear to the ring around the shadow.
 */
